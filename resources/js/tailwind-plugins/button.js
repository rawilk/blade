...
module.exports = plugin.withOptions(function (options = {}) {
    return function ({ addComponents, addUtilities, config, theme }) {
        const expectedVariants = ['50', '100', '200', '300', '400', '500', '600', '700', '800', '900'],
              buttons = {},
              colors = filterColors(theme('colors'), expectedVariants),
              darkSelector = darkModeSelector(config('darkMode', 'class'));
        ...
        for (const colorName in colors) {
            ...
            if (options.outline ?? true) {
                ...
                addDarkVariant(buttonUtils, `.button-outlined.button--${colorName}:hover:not([disabled]):not(.button--disabled):not(.button--busy):not(.button--no-hover)`, darkSelector, {
            ...
            if (options.text ?? true) {
                ...
                addDarkVariant(buttonUtils, `.button-text.button--${colorName}`, darkSelector, {
